...
public class taskera {
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            final Window window = new BasicWindow("Taskera: Home Page\n");
            ...
            should be.
             */
            Panel contentPanel = new Panel(new GridLayout(9));
             ...
             */
            Label title = new Label("\nWelcome to Taskera! This is the beginning of your journey.");
            ...
            Label title2 = new Label("***'tab' to navigate, 'enter' to select***");
            title2.setLayoutData(GridLayout.createLayoutData(
                    ...
                    9,                  // Horizontal span
                    1));                  // Vertical span
            contentPanel.addComponent(title2);
            ...
            contentPanel.addComponent(new TextBox().setLayoutData(GridLayout.createHorizontallyFilledLayoutData(9)));
            ...
            contentPanel.addComponent(new TextBox().setMask('*').setLayoutData(GridLayout.createHorizontallyFilledLayoutData(9)));
             ...
             */
            contentPanel.addComponent(new Label("Time Zone:"));
            ...
            readOnlyComboBox.setLayoutData(GridLayout.createHorizontallyFilledLayoutData(9));
            readOnlyComboBox.setPreferredSize(new TerminalSize(20, 1));
            contentPanel.addComponent(readOnlyComboBox);

            contentPanel.addComponent(new Label("Type of User"));
            contentPanel.addComponent(
                    new ComboBox<>("Admin", "User")
                            .setReadOnly(false)
                            .setLayoutData(GridLayout.createHorizontallyFilledLayoutData(9)));
             ...
             */
            contentPanel.addComponent(new Label("Login"));
            contentPanel.addComponent(new Button("Button", () -> MessageDialog.showMessageDialog(textGUI, "Login Successfull", " wait for 3 seconds please...", MessageDialogButton.OK)).setLayoutData(GridLayout.createLayoutData(GridLayout.Alignment.CENTER, GridLayout.Alignment.CENTER, true, false, 9, 1)));
            ...
            contentPanel.addComponent(
                    new EmptySpace()
                            .setLayoutData(
                                    GridLayout.createHorizontallyFilledLayoutData(9)));
